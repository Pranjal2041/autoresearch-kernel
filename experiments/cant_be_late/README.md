...
(originally from the Can't Be Late paper, NSDI '24), with one patch: the
top-level wandb import in `simulate.py` is optional, mirroring the stub
their own `main.py` uses. Traces are 8 of the real spot-availability
